    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (!dbContext.IsApplicationInstalled())
                {
                    if (model.UserName == "admin" && model.Password == "admin!")
                    {
                        var user = new ApplicationUser() { UserName = "admin" , OrganizationId = ""};

                        user.Roles.Add("SuperAdmin");
                        var result = await this.UserManager.CreateAsync(user, "welkom!");
                        if (result.Succeeded)
                        {
                            dbContext.FinishApplicationSetup();
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            //Claim cl = new Claim("Authrization", "Designer");
            //IdentityUserClaim clm = new IdentityUserClaim();
            //clm.ClaimType = "Authorization";
            //clm.ClaimValue = "Designer";
